...
function loop() {   // scroll function

  // position measurments:

  var top = window.pageYOffset; // verticall scroll position
  var sections = document.querySelectorAll(".section"); // backgrounds
  var replaceContainer = document.querySelectorAll(".kt-container"); //img switch container
  var replaceItem = document.querySelectorAll(".kintamasis"); // 2 divs with img
